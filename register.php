...
<section class="main__middle__container register">
  <div class="row text-center no-margin nothing">
    <div class="container headings">
      <h1 class="page_title">Register</h1>
      <div class="seper"></div>

      <form action="reg_process.php" method="POST" class="form-inline" role="form">
          <div class="form-group">
            
           <h5><input type="text" class="form-control form-control-lg" name="name" placeholder="Name"></h5>
          
           <h5><input type="text" class="form-control form-control-lg" name="username" placeholder="Username"></h5>
            
          <h5><input type="email" class="form-control form-control-lg" name="email" placeholder="Email"></h5>
            
           <h5><input type="password" class="form-control form-control-lg" name="password" placeholder="Password"></h5>
            
            <h6>*All fields are required*</h6>

          <button <a type="submit" class="btn btn-info btn-lg" name="btn-reg"  role="button">register</a></button>
          </div>
